...
const testimonialSeed = [
  { name: "نگار احمدی", treatment: "لمینت سرامیکی", rating: 5, comment: "دقیقاً همان چیزی شد که در شبیه‌سازی دیده بودم. دکتر محمدی قبل از تراش مکاپ گذاشت و نتیجه را تأیید کردم.", sortOrder: 1 },
  { name: "مهدی کاظمی", treatment: "ایمپلنت", rating: 5, comment: "بعد از ۱۵ سال بی‌دندانی، دو ایمپلنت گذاشتم. جراحی بدون درد بود و روز بعد سر کار بودم.", sortOrder: 2 },
  { name: "الهام رستمی", treatment: "ارتودنسی نامرئی", rating: 5, comment: "کسی متوجه الاینرها نشد. نوبت‌دهی آنلاین خیلی کمک کرد که با کارم هماهنگ باشم.", sortOrder: 3 },
  { name: "سعید مقدم", treatment: "درمان ریشه", rating: 5, comment: "درد شدید داشتیم و در همان روز پذیرش شدم. درمان ریشه در یک جلسه تمام شد.", sortOrder: 4 },
  { name: "پریسا نوری", treatment: "بلیچینگ", rating: 4, comment: "دندان‌ها ۶ درجه روشن شد. حساسیت جزئی داشت که با ژل فلوراید کنترل شد.", sortOrder: 5 },
  { name: "رضا شریفی", treatment: "جرم‌گیری", rating: 5, comment: "کلینیک تمیز و منظم، وقت‌ها دقیق رعایت می‌شود و پذیرش خیلی محترمانه برخورد می‌کند.", sortOrder: 6 },
];

const taskSeed = [
  { phase: "فاز ۱ · راه‌اندازی", title: "نصب و پیکربندی قالب تخصصی دندانپزشکی", description: "پیاده‌سازی ظاهر و ساختار معادل Dentalia روی Next.js با پشتیبانی کامل راست‌به‌چپ و فارسی.", owner: "تیم فنی", status: "done", sortOrder: 1 },
  { phase: "فاز ۱ · راه‌اندازی", title: "ریسپانسیو موبایل و دسکتاپ", description: "تست صفحات در بریک‌پوینت ۳۶۰ تا ۱۹۲۰ پیکسل، منوی همبرگری و دکمه تماس چسبان.", owner: "تیم فنی", status: "done", sortOrder: 2 },
  { phase: "فاز ۲ · محتوا", title: "راه‌اندازی سیستم مدیریت محتوا (CMS)", description: "پنل مدیریت با جداسازی مقالات، خدمات، تیم پزشکی، گالری و نوبت‌ها.", owner: "تیم فنی", status: "done", sortOrder: 3 },
  { phase: "فاز ۲ · محتوا", title: "فرم نوبت‌دهی با حداقل فیلد", description: "نام، شماره تماس، خدمت، تاریخ و ساعت — همه در یک صفحه، ذخیره مستقیم در دیتابیس.", owner: "تیم فنی", status: "done", sortOrder: 4 },
  { phase: "فاز ۲ · محتوا", title: "بلاگ و انتشار ۵ مقاله پایه", description: "۵ مقاله سئوشده با ساختار H2/H3، لینک داخلی و اسکیما BlogPosting.", owner: "تیم محتوا", status: "done", sortOrder: 5 },
  { phase: "فاز ۳ · سئو", title: "سئو داخلی و داده ساختاریافته", description: "متادیتا، Canonical، OpenGraph، Schema Dentist/LocalBusiness/FAQ/Breadcrumb و نقشه سایت XML.", owner: "تیم سئو", status: "done", sortOrder: 6 },
  { phase: "فاز ۳ · سئو", title: "بهینه‌سازی سرعت و Core Web Vitals", description: "تصاویر WebP/AVIF با next/image، فونت‌های سبک، حذف جاوااسکریپت اضافه و کش لبه.", owner: "تیم فنی", status: "done", sortOrder: 7 },
  { phase: "فاز ۳ · سئو", title: "ثبت در گوگل سرچ کنسول و ارسال سایت‌مپ", description: "تأیید مالکیت با متاتگ، ارسال sitemap.xml و پایش کوئری‌های محلی.", owner: "تیم سئو", status: "todo", sortOrder: 8 },
  { phase: "فاز ۳ · سئو", title: "ثبت و بهینه‌سازی پروفایل گوگل بیزینس (نقشه)", description: "دسته‌بندی Dentist، ساعات کاری، عکس مطب، پاسخ به نظرات و کد جاسازی نقشه.", owner: "تیم سئو", status: "doing", sortOrder: 9 },
  { phase: "فاز ۴ · تحویل", title: "نصب SSL و فعال‌سازی HTTPS", description: "گواهی Let's Encrypt با تمدید خودکار، ریدایرکت ۳۰۱ به https و هدر HSTS.", owner: "تیم فنی", status: "doing", sortOrder: 10 },
  { phase: "فاز ۴ · تحویل", title: "بکاپ‌گیری خودکار و مانیتورینگ آپتایم", description: "بکاپ روزانه دیتابیس و آلرت در صورت قطع دسترسی.", owner: "تیم فنی", status: "todo", sortOrder: 11 },
  { phase: "فاز ۴ · تحویل", title: "آموزش پشتیبانی اولیه به کارفرما", description: "ویدیو و راهنمای متنی: افزودن مقاله، ویرایش خدمات، مدیریت نوبت‌ها و پاسخ به نظرات.", owner: "تیم فنی", status: "todo", sortOrder: 12 },
];
...
const settingsSeed: Record<string, string> = {
  ...
  address: "تهران، سعادت‌آباد، بلوار دریا، نبش خیابان صراف‌ها، برج پزشکان مهر، طبقه ۴، واحد ۴۰۲",
  ...
  siteUrl: "",
  googleVerification: "",
  emergencyNote: "اورژانس دندانپزشکی در تمام روزهای هفته از ۸ صبح تا ۱۱ شب پاسخگویی دارد.",
};

async function isEmpty(table: "services" | "team_members" | "gallery_cases" | "posts" | "testimonials" | "tasks" | "settings") {
  const rows = await db.execute<{ count: string }>(sql.raw(`select count(*)::text as count from ${table}`));
...
export async function seedDatabase() {
  ...
  if (await isEmpty("team_members")) {
    await db.insert(teamMembers).values(teamSeed).onConflictDoNothing();
  }
  if (await isEmpty("gallery_cases")) {
    await db.insert(galleryCases).values(gallerySeed).onConflictDoNothing();
  }
    ...
    await db
      ...
      .values(
        postSeed.map((post, index) => ({
          ...post,
          publishedAt: new Date(now - index * 86400000 * 3),
          updatedAt: new Date(now - index * 86400000 * 3),
        })),
      )
      .onConflictDoNothing();
  }
  ...
  if (await isEmpty("tasks")) {
    await db.insert(tasks).values(taskSeed).onConflictDoNothing();
  }
  if (await isEmpty("settings")) {
    await db
      .insert(settings)
      .values(Object.entries(settingsSeed).map(([key, value]) => ({ key, value })))
      .onConflictDoNothing();
  }
}
